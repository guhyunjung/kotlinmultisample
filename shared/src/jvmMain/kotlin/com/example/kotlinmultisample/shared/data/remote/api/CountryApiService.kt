 ...
 *
 * Android의 CountryApiService와 동일한 인터페이스이지만
 * jvmMain에 별도로 정의합니다.
 * (Retrofit 인터페이스는 JVM/Android 소스셋을 분리하여 관리)
 */
interface CountryApiService {

    /**
     * 전체 국가 목록 조회
     * GET /v3.1/all?fields=name,capital,currencies,cca2,cca3,flag,region,flags
     *
     ...
     * GET /v3.1/alpha/{code}
     *
     * REST Countries API는 단건 조회도 List로 반환합니다.
